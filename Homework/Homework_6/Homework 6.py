...
# 2nd variant    
    ...
    #     for employee, country in employee_residence.items():
    #         file.write(f"{employee} {country}\n".encode())
    # shutil.make_archive("backup_folder", "zip", path)
    # return f"{path}/backup_folder.zip"

## Task 14_14 #def unpack(archive_path, path_to_unpack)
# викликатиме метод пакета shutil unpack_archive та
